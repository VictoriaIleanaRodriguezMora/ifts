...
![alt text](./img/image-1.png) esta parte me dice las caracteristicas que tengo con esta version. los logs de version 
...
En `System ./img/image`, me dice que tengo que bajarme la ./img/imagen para la virtualización de este dispositivo
`Additional settings`
