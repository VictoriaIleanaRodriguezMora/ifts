...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?){
        ...
        // val es variable constante
        val nombreAlumno = "Fulano"
        val cursoAlumno = "TSDS"

        //Dentro de setContent le indicamos a Composable cual va a ser la interfaz que vamos a mostrar
        // seteando contenido
        setContent {
            PantallaPrincipal(nombre=nombreAlumno, curso = cursoAlumno) // defino los parametros de la funcion. le puedo dar valores por defecto
        }
    }
}
...
fun PantallaPrincipal(nombre: String, curso: String){
    Column(
        ...
        Mensaje(texto="Hola $nombre", tamano=30.sp, color = Color.Blue) // USANDO LA VARIABLE DEFINIDA EN EL ACTIVITY
        Mensaje(texto="Tu curso es: $curso", tamano=25.sp, color = Color.Green)
